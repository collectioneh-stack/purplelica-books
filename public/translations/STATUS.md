...
> **마지막 디스크 실사: 2026-06-04** (전체 84개 폴더 content 기준 권위 스캔 — 시집 모드 챕터 제목 페이지는 정상 빈칸으로 완료 처리)

- ✅ 완료: **80권**  ⏳ 진행 중(부분): **0권**  🛠 JSON 손상: **1권**  ⚪ 빈 페이지만: **3권**  ❌ 폴더 없음: **8권**
- 🌐 **사이트 노출 후보**: 완료 80권 (pg67·pg83·pg3207·pg7849 신규 완역 확인 — `TRANSLATED_IDS` 추가 검토)
- 6/1→6/5 변경: pg67·83·1404·3207·7849 완역 합류 / pg1260 제인에어·pg345 드라큘라 앱-분할 전량 재번역 완료 / pg236 손상 발견
- ⚠️ **별도 진단**: 앱 정합 전수검사 결과 49권이 MISALIGNED/INCOMPLETE/EMPTY (regroup 손상). 상세: `outputs/2026/06/05/[분석]_북맵_깨진책_전수리스트.md`
...
| pg67 | 미국의 흑인 경험 | The Black Experience in America | 152 | ✓ |
| pg74 | 톰 소여의 모험 | The Adventures of Tom Sawyer, Complete | 143 | ✓ |
| pg76 | 허클베리 핀의 모험 | Adventures of Huckleberry Finn | 6 | ✓ |
| pg83 | 지구에서 달까지 | From the Earth to the moon; and, round the moon | 139 | ✓ |
...
| pg1260 | 제인 에어 | Jane Eyre: An Autobiography | 353 | ✓ |
...
| pg1404 | 연방주의자 논집 | The Federalist Papers | 489 | ✓ |
...
| pg7849 | 심판 | The Trial | 94 | ✓ |
| pg11339 | 이솝 우화 | Aesop's Fables; a new translation | 288(본문) | ✓ |

## 번역 진행 중

_(없음 — pg345 드라큘라, pg1260 제인에어 재번역 완료)_

## 🛠 JSON 손상 (재생성 필요)

| PG ID | 한국어 제목 | 원제 | 내용/본문 | 손상 페이지 |
|:---:|:---|:---|:---:|:---|
| pg236 | 정글북 | The Jungle Book | 36/45 | 9개 파싱 실패 (p7,19,20,21,23…) — 앱에서 번역 미표시 |

## 미번역 (빈 페이지 100% / 빈 폴더)

| PG ID | 한국어 제목 | 원제 | 페이지 수 |
|:---:|:---|:---|:---:|
| pg1184 | 몬테크리스토 백작 | The Count of Monte Cristo | 873 (전부 빈칸) |
| pg2600 | 전쟁과 평화 | War and Peace | 1192 (전부 빈칸) |
| pg2268 | 안토니우스와 클레오파트라 | Antony and Cleopatra | 폴더만 존재, 0파일 |
