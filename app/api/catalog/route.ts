...
// 마지막 갱신: 2026-06-01 — 72권
// 변경: pg11339 이솝 우화 추가 (본문 288p 완역, 빈 페이지 286p는 splitIntoChapterPages 시집 모드의 챕터 제목 전용 페이지)
// 제외: pg1404 연방주의자(96%) — 분할 불일치로 100% 완료 못 함
const TRANSLATED_IDS = new Set([
  11, 16, 23, 35, 36, 41, 43, 45, 46, 55, 61, 74, 76, 84,
  98, 103, 105, 120, 132, 135, 139, 141, 158, 160, 161, 174, 209, 215, 219, 236,
  ...
  2542, 2554, 2701, 2814, 2852, 3825, 4085, 4300, 4363, 4517, 5200, 5230, 5765, 6130, 11339,
])
