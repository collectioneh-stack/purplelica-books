...
// STATUS.md 기준 번역 완료 도서 (2026-05-22 갱신)
const TRANSLATED_IDS = new Set([
  11, 16, 23, 35, 36, 41, 43, 45, 46, 76, 84,
  98, 103, 105, 120, 132, 135, 139, 141, 160, 215, 236,
  345, 600, 721, 1064, 1080, 1260, 1317, 1342, 1400, 1404,
  1497, 1661, 1728, 1934, 1952, 2097, 2197, 2500, 2542, 2701, 2852,
  3825, 4085, 4363, 5200, 6130,
])
