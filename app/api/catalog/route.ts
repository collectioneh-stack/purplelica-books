...
// 마지막 갱신: 2026-06-01 (v3) — 76권
// 변경: 짧은 책 4권 추가 노출 (pg216 도덕경, pg408 흑인의 영혼, pg1327 엘리자베스와 독일 정원, pg2680 명상록)
// 제외: pg1404 연방주의자(96%) — 분할 불일치로 100% 완료 못 함
const TRANSLATED_IDS = new Set([
  ...
  1317, 1322, 1327, 1342, 1399, 1400, 1497, 1661, 1728, 1934, 1952, 2097, 2197, 2500,
  2542, 2554, 2680, 2701, 2814, 2852, 3825, 4085, 4300, 4363, 4517, 5200, 5230, 5765, 6130, 11339,
])
