...
// 번역 완성도 95%+ 서비스 가능 도서만 노출
// 디스크 실측 기준 (2026-05-29 갱신) — 58권 (+161 이성과 감성, +768 폭풍의 언덕)
const TRANSLATED_IDS = new Set([
  11, 16, 23, 35, 36, 41, 43, 45, 46, 55, 61, 76, 84,
  98, 103, 105, 120, 132, 135, 139, 141, 158, 160, 161, 174, 215, 236,
  244, 345, 721, 768, 1064, 1080, 1232, 1251, 1260, 1317, 1342, 1399, 1404,
  1497, 1661, 1728, 1934, 1952, 2197, 2500, 2542, 2554, 2701, 2814, 2852,
  3825, 4085, 4363, 5200, 5230, 6130,
])
