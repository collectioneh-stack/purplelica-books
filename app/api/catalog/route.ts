...
// 마지막 갱신: 2026-06-01 (v4) — 79권
// 변경: pg67 미국의 흑인 경험, pg7849 심판, pg1404 연방주의자 추가 노출
// pg1404 주의: 분할 불일치 책이지만 워커가 _source 489p 기준 새 디스크 페이지 생성 → 489/489 완역 상태
const TRANSLATED_IDS = new Set([
  11, 16, 23, 35, 36, 41, 43, 45, 46, 55, 61, 67, 74, 76, 84,
  98, 103, 105, 120, 132, 135, 139, 141, 158, 160, 161, 174, 209, 215, 216, 219, 236,
  244, 308, 345, 408, 526, 600, 721, 768, 863, 1007, 1064, 1080, 1232, 1251, 1260,
  1317, 1322, 1327, 1342, 1399, 1400, 1404, 1497, 1661, 1728, 1934, 1952, 2097, 2197, 2500,
  2542, 2554, 2680, 2701, 2814, 2852, 3825, 4085, 4300, 4363, 4517, 5200, 5230, 5765, 6130, 7849, 11339,
])
